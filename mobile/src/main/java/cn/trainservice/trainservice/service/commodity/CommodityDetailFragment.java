package cn.trainservice.trainservice.service.commodity;
...
import cn.trainservice.trainservice.service.commodity.dummy.DummyContent;
...
public class CommodityDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.commodity_detail)).setText(mItem.details);
        }
